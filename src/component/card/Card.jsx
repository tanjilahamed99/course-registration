...
const Card = ({ card, handleCart }) => {
    ...
    return (
        <div className='bg-white p-4 shadow-md shadow-white'>
            <img className='w-[280px] mb-4 text-center' src={image} alt="" />
            ...
            <button onClick={() => handleCart(card,price,credit)} className='btn btn-primary bg-[#2F80ED] w-full text-white'>Select</button>
        </div>
    );
};
